...
| `src/editor/bodyEditTransaction.ts` + `bodyEditorTransaction.ts` | Implemented UI-neutral classification plus concrete pre-application ProseMirror/`beforeinput` observation and dispatch wiring |
