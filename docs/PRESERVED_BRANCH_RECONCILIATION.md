...
| Formatting and provenance have different mutation/inheritance semantics | adapted                            | Preserved inside `application/vnd.coedit.text`: formatting follows explicit boundary policies, while fine-grained text Origin never inherits and cannot be cleared by formatting. Blob Origin is whole-payload.                                                                                                                                                                                                                                                           |
