...
| Markdown import                   | 10 MiB UTF-8 source, 200,000 AST nodes, depth 100, and 1 KiB source-name metadata                                                                                                                                                           | Experimental guard candidates                                                                   | `MARKDOWN_INTERCHANGE.md`; Step 5                                                     |
| Portable `.coedit` processing     | 64 MiB UTF-8 JSON, depth 128, 64 parent/frontier references, 250,000 operations per Contribution, 1,000,000 operations per archive, 8 MiB per decoded chunk, 48 MiB decoded chunks per archive, and 1,000,000 code points per InlineContent | Experimental guard candidates                                                                   | `PORTABLE_DOCUMENT_FORMAT.md`; Step 6 and version-1 freeze                            |
| Carrier and storage qualification | 100,000 code points, 5,000 Contributions, and 50 ms local-update latency                                                                                                                                                                    | Experimental workload and latency candidates                                                    | `MVP_VERIFICATION_PLAN.md`; Step 3, with later browser reuse evaluated in Steps 11-12 |
| Preserved editor grouping         | 20 graphemes, 30 seconds, and two pending captures                                                                                                                                                                                          | Experimental comparison fixtures inherited from the preserved branch, not normative settings    | `MVP_IMPLEMENTATION_SPEC.md`; Step 9 measurements                                     |
