...
| [`0005-semantic-interpretation-boundaries.md`](0005-semantic-interpretation-boundaries.md)                         | Accepted; link and formatting examples refined by ADR 0010 | Durable semantic boundaries, application-owned link interpretation, and implementation-capacity limits                     |
| [`0006-text-position-ownership.md`](0006-text-position-ownership.md)                                               | Accepted; payload scope refined by ADR 0010                | Editor-native transient positions, allowlisted native-string carrier-position boundaries, and coordinate ownership         |
