...
| ADR                                                                                                                | Status                                                  | Subject                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [`0001-collaborative-content-provenance-history.md`](0001-collaborative-content-provenance-history.md)             | Accepted; payload-shape scope refined by ADR 0010       | Intrinsic `application/vnd.coedit.text` metadata, provenance, comments, causal History, persistence, and technology direction |
...
| [`0009-durable-range-semantics.md`](0009-durable-range-semantics.md)                                               | Accepted behavior; Step 6 representation unresolved     | Document-relative multi-span `application/vnd.coedit.text` Range semantics, permanent Version basis, and staged qualification |
