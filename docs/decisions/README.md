...
| [`0008-durable-range-semantics.md`](0008-durable-range-semantics.md) | Accepted behavior; representation unresolved | External multi-span Range semantics, structural tracking, and serialization boundaries |
