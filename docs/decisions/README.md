...
| [`0008-durable-range-semantics.md`](0008-durable-range-semantics.md)                                               | Accepted behavior; Step 6 representation unresolved | Durable multi-span Range semantics, service boundary, and staged qualification                            |
