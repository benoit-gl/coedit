...
| [`0003-flat-structural-placement.md`](0003-flat-structural-placement.md)                                           | Superseded in part by ADR 0011                          | Flat Block placement, recoverable structural convergence, and position-allocation qualification                            |
...
| [`0011-minimal-indicated-structural-depth.md`](0011-minimal-indicated-structural-depth.md)                         | Accepted                                                | Minimum valid indicated depths for created and moved structural runs                                                       |
