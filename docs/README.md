...
production raw text processor and exact supported charset set. Range lineage
remains a Gate C decision. The stage-by-stage status is in
[`INLINE_CONTENT_PAYLOADS.md`](INLINE_CONTENT_PAYLOADS.md#131-implementation-status-and-decision-ownership).
