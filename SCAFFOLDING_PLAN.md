...
- exact collaboration for ordinary supported native ECMAScript strings for both allowlisted fine-grained Media Types, including ill-formed string edge cases such as lone surrogates, with exact preservation on success or atomic rejection when unsupported;
...
### Gate E — Interactive text editing
