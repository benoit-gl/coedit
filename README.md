...
Coedit is a browser-first collaborative document engine. The repository contains the completed Step 1 browser scaffold and Step 2 pure Block domain. Step 3 carrier qualification is the next implementation step. Gate B then selects the carrier, Step 4 implements the selected collaborative core, Step 5 establishes History and Versions, and Step 6 implements the durable Range service.
